			...
			<div class="table tablePrato">
				...
				<?php foreach ($pratos as $prato) { ?>
					<div class="row">
						...
						<div class="cell">
							<span id="<?php echo 'valor-' . $prato['id_prato'] ?>"><?php echo "R$ " . number_format($prato['vl_prato'], 2, ",", "."); ?></span>
						</div>
						<div class="cell">
		...
		<div class="row">
			<form id="pratos-editar-form">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="codigoPrato" name="codigoPrato" value="<?php //adicionar
																										?>" readonly>
				</div>
				<div class="form-group">
